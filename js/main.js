...
// ============================================
// FOOTER INCLUDE (Astro-style component)
// ============================================
async function initFooter() {
    ...
    const logoPath = isPagesFolder ? '../7arts logo-05.png' : '7arts logo-05.png';

    const footerHTML = `
    <footer class="bg-theatre-dark py-12 relative">
        <div class="container mx-auto px-6">
            <div class="grid md:grid-cols-4 gap-8 mb-8">
                <div>
                    <a href="${basePath}index.html" class="inline-block mb-4">
                        <img src="${logoPath}" alt="7 Arts Theatre" class="h-16 w-auto">
                    </a>
                    <p class="text-gray-400 mb-4">Your premier destination for events, performances, and celebrations in Harare, Zimbabwe.</p>
                ...
                <div>
                    <h4 class="font-display text-xl font-semibold mb-4">Quick Links</h4>
                    <ul class="space-y-2">
                        <li><a href="${basePath}index.html" class="text-gray-400 hover:text-gold-accent transition-colors">Home</a></li>
                        <li><a href="${basePath}pages/about.html" class="text-gray-400 hover:text-gold-accent transition-colors">About Us</a></li>
                        <li><a href="${basePath}pages/events.html" class="text-gray-400 hover:text-gold-accent transition-colors">Events</a></li>
                        <li><a href="${basePath}pages/services.html" class="text-gray-400 hover:text-gold-accent transition-colors">Services</a></li>
                        <li><a href="${basePath}pages/products.html" class="text-gray-400 hover:text-gold-accent transition-colors">Products</a></ul>
                </li>
                    </div>

                <div>
                    <h4 class="font-display text-xl font-semibold mb-4">Services</h4>
                    <ul class="space-y-2">
                        <li><a href="${basePath}pages/services.html" class="text-gray-400 hover:text-gold-accent transition-colors">Event Spaces</a></li>
                        <li><a href="${basePath}pages/services.html" class="text-gray-400 hover:text-gold-accent transition-colors">Corporate Functions</a></li>
                        <li><a href="${basePath}pages/services.html" class="text-gray-400 hover:text-gold-accent transition-colors">Musical Theatre</a></li>
                        <li><a href="${basePath}pages/services.html" class="text-gray-400 hover:text-gold-accent transition-colors">Product Launches</a></li>
                        <li><a href="${basePath}pages/services.html" class="text-gray-400 hover:text-gold-accent transition-colors">Award Ceremonies</a></li>
                    </ul>
                </div>

                <div>
                    <h4 class="font-display text-xl font-semibold mb-4">Contact</h4>
                    <ul class="space-y-3 text-gray-400">
                        <li class="flex items-start">
                            <svg class="w-5 h-5 text-gold-accent mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                            </svg>
                            <span>Sammer Gallery, Avondale Shopping Centre, Harare, Zimbabwe</span>
                        </li>
                        <li class="flex items-center">
                            <svg class="w-5 h-5 text-gold-accent mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                            </svg>
                            <span>+263 77 954 0395</span>
                        </li>
                        <li class="flex items-center">
                            <svg class="w-5 h-5 text-gold-accent mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                            </svg>
                            <span>pastorjeph@7artstheatre.com</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="border-t border-gray-800 pt-6 text-center">
                <p class="text-gray-500 text-sm">&copy; 2026 7 Arts Theatre. All rights reserved. | Harare, Zimbabwe</p>
                <p class="text-gray-600 text-xs mt-2">Designed by <strong>Claudius Mainja</strong> and developed at <a href="https://www.blacklemur.co.zw" target="_blank" rel="noopener noreferrer" class="text-gold-accent hover:text-white transition-colors">Blacklemur Innovations</a> | www.7artstheatre.com</p>
            </div>
        </div>
    </footer>
    `;
